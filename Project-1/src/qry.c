...
bool mineInDisplacement (list list, Info figure, char t, char direction, double dx, double dy, FILE* txt_results, FILE* modifiedSVG) {
    char typeFigure = t;
    char type;
    bool found = false;
    bool remove = false;
...
bool rectangleInside(double x, double y, Info rectangle) {   
...
bool circleInside(double x, double y, Info circle) {
...
bool lineInside(double x, double y, Info line) {
...
bool textInside(double x, double y, Info text) {
...
bool insideIrradiation(double x, double y, double r, Info figure) {
    Item item;
...
void tp(list list, Info info, FILE* svg, FILE* txt_results, double x, double y, score points) {
    Info item;
    Info aux;
    bool found = false;
    char type;
...
void tr(list list, Info info, FILE* svg, FILE* txt_results, double x, double y, double dx, double dy, char id[], score points) {
    Info item;
    Info aux;
    int idInt = atoi(id);
    bool found = false;
...
void be(list list, Info info, FILE* svg, FILE* txt_results, double x, double y, double r, double agress, score points) {
    Info item;
    Info aux;
    Info aux_remove = NULL;
    bool found = false;
...
void mvh (list lista, list selected, FILE* txt_results, FILE* svg, Info info, int j, int k, double dx, int naucap[], score points) {
    Info item;
    Info aux;
    bool mine = false;
    bool found = false;
...
void mvv (list lista, list selected, FILE* txt_results, FILE* svg, Info info, int j, int k, double dy, int naucap[], score points) {
    Info item;
    Info aux;
    bool mine = false;
    bool found = false;
...
void get_functions(path paths, FILE* txt_results, list list, score points) {
...
void format_qry_results(path paths, list list, score points) {
    FILE* txt_results = fopen(get_path_TXTQry(paths), "w+");

    fprintf(txt_results, "-Matheus Kenzo-");
    fprintf(txt_results, "\nFunções executadas:");
    get_functions(paths, txt_results, list, points);
